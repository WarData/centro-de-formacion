...
Las órdenes de reparación son los documentos donde se gestionan las reparaciones que se hacen sobre los vehículos. En una orden de reparación podremos recoger los servicios, mano de obra y recambios que se necesitan. A cada orden a su vez se le podrán imputar los tiempos dedicados a la reparación del vehículo por parte de cada mecánico ([intervenciones](../intervenciones.md)). Todo lo que carguemos a cada orden se podrá clasificar entre distintos tipos de cargo (cliente, siniestro, garantía o interno).
