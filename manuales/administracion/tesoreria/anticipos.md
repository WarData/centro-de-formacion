...
* Si el cliente tiene anticipos a su nombre, además del aplicado al pedido de ventas de 100 €uros, se sumarán. Aquí vemos que al pulsar en "Aplicar anticipos" nos indica los 3 anticipos a su nombre disponibles - añadimos el último de 500 €uros a los 100 €uros añadidos desde el pedido de ventas directamente:

<figure><img src="../../../.gitbook/assets/image (686).png" alt=""><figcaption></figcaption></figure>

* Aquí aparecen como compensación aplicados al cobro de la factura:
